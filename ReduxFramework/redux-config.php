<?php
   ...
   // $opt_name = apply_filters( 'redux_demo/opt_name', $opt_name );
    ...
    $args = array(
        ...
        'menu_title'           => __( 'Desiblitz Theme Settings', 'redux-framework-demo' ),
        'page_title'           => __( 'Desiblitz Theme Settings', 'redux-framework-demo' ),
    ...
    if ( ! isset( $args['global_variable'] ) || $args['global_variable'] !== false ) {
        ...
        $args['intro_text'] = sprintf( __( '<p>Make all the changes to the theme here.</p>', 'redux-framework-demo' ), $v );
    } else {
