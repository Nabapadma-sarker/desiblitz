...
<html lang="en">
  <head>
	...
	<link href="<?php echo get_template_directory_uri(); ?>/css/mailerlite_universal.css" type="text/css" rel="stylesheet" /> 
    <link href="<?php echo get_template_directory_uri(); ?>/css/styles.css" type="text/css" rel="stylesheet" />
      <link href="<?php echo get_template_directory_uri(); ?>/css/customization.css" type="text/css" rel="stylesheet" />
	<!-- <link href="< ?php echo get_template_directory_uri(); ?>/css/styles.less" type="text/css" rel="stylesheet/less"  /> -->
...
<!-- ml('css', false); ml('accounts','208619','53ffab0fae087','load'); -->
setTimeout(function() {
	    ...
	    <div class="container hdr_container">	    	
	    	...
	    	<div class="item logo">
	    		...
	    		<nav class="toggleContainer-links">
					...
					<a href="https://www.desiblitz.com/content/category/competitions">Competitions</a>
					<a href="https://www.desiblitz.com/video">Videos</a>
					</span>

	    		</nav>
	    		<h1>
	    			<a class="biglogo" href="<?php bloginfo('url'); ?>" title="<?php bloginfo('name'); ?>">
						<img src="<?php echo get_template_directory_uri(); ?>/images/desktop-header-logo.jpg" alt="<?php bloginfo('name'); ?>" />
	    			</a>
