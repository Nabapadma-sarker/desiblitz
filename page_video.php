					...
					$.get(
							...
							function(data){
								...
								$.each(videoResults, function(i , item){							
									...
									output += '<a class="fancybox-media" href=" https://www.youtube.com/watch?v='+link+' " title="'+videTitle+'"><img src=" '+videoThumb+' "/></a>';
									output += '</figure><h3>';
									output += '<a class="fancybox-media" href=" https://www.youtube.com/watch?v='+link+' " title="'+videTitle+'">'+videTitle+'</a>';
									output += '</h3></figure>';
									output += '</div>';
									output += '</article>';
									output += '</div>';
