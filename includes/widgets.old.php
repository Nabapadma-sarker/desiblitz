<?php
	...
	/*******************************************
		WIDGET AREA - HEADER ADVERT
	********************************************/
	function lym_header_ad_left() {		
		register_sidebar( array(			
					'name' => 'Header Advert Left',
					'id' => 'header-advert-left',
					));	
	}	
	add_action( 'widgets_init', 'lym_header_ad_left' );
	
	function lym_header_ad_right() {		
		register_sidebar( array(			
					'name' => 'Header Advert Right',
					'id' => 'header-advert-right',
					));	
	}	
	add_action( 'widgets_init', 'lym_header_ad_right' );
	...
	********************************************/
	function lym_home_twoPosts() {		
		register_sidebar( array(			
					'name' => 'Home Page - Two Posts Section',			
					'id' => 'home_two_posts',
					));	
	}	
	...
	********************************************/
	function lym_home_fullwidth_ad() {		
		register_sidebar( array(			
					'name' => 'FULL WIDTH AD - One Posts Section',			
					'id' => 'fullwidth_ad',
					));	
	}	
	...
	********************************************/
	...
	function taboo_cat_single() {		
		register_sidebar( array(			
					'name' => 'Taboo - Category Single Post',			
	...
	function taboo_cat_latest() {		
		register_sidebar( array(			
					'name' => 'Taboo - Category Latest Posts',			
	...
	********************************************/
	function musicdance_cat_banner() {		
		register_sidebar( array(			
					'name' => 'Music & Dance - Category Banner',			
	...
	function musicdance_cat_trending() {		
		register_sidebar( array(			
					'name' => 'Music & Dance - Category Trending',			
	...
	function musicdance_cat_single() {		
		register_sidebar( array(			
					'name' => 'Music & Dance - Category Single Post',			
	...
	function musicdance_cat_latest() {		
		register_sidebar( array(			
					'name' => 'Music & Dance - Category Latest Posts',			
	...
	********************************************/
	...
	function food_cat_single() {		
		register_sidebar( array(			
					'name' => 'Food - Category Single Post',			
	...
	function food_cat_latest() {		
		register_sidebar( array(			
					'name' => 'Food - Category Latest Posts',			
	...
	/*******************************************
		WIDGET AREA - Healthy & Beauty Category
	********************************************/
	function healthybeauty_cat_banner() {		
		register_sidebar( array(			
					'name' => 'Healthy & Beauty - Category Banner',			
	...
	function healthybeauty_cat_trending() {		
		register_sidebar( array(			
					'name' => 'Healthy & Beauty - Category Trending',			
	...
	function healthybeauty_cat_single() {		
		register_sidebar( array(			
					'name' => 'Healthy & Beauty - Category Single Post',			
	...
	function healthybeauty_cat_latest() {		
		register_sidebar( array(			
					'name' => 'Healthy & Beauty - Category Latest Posts',			
	...
	/*******************************************
		WIDGET AREA - ART & CULTURE Category
	********************************************/
	function artculture_cat_banner() {		
		register_sidebar( array(			
					'name' => 'Art & Culture - Category Banner',			
	...
	function artculture_cat_trending() {		
		register_sidebar( array(			
					'name' => 'Art & Culture - Category Trending',			
	...
	function artculture_cat_single() {		
		register_sidebar( array(			
					'name' => 'Art & Culture - Category Single Post',			
	...
	function artculture_cat_latest() {		
		register_sidebar( array(			
					'name' => 'Art & Culture - Category Latest Posts',			
	...
	********************************************/
	function britasian_cat_banner() {		
		register_sidebar( array(			
					'name' => 'Brit Asian - Category Banner',			
	...
	function britasian_cat_trending() {		
		register_sidebar( array(			
					'name' => 'Brit Asian - Category Trending',			
	...
	function britasian_cat_single() {		
		register_sidebar( array(			
					'name' => 'Brit Asian - Category Single Post',			
	...
	function britasian_cat_latest() {		
		register_sidebar( array(			
					'name' => 'Brit Asian - Category Latest Posts',			
	...
	/*******************************************
		WIDGET AREA - CINEMA Category
	********************************************/
	function cinema_cat_banner() {		
		register_sidebar( array(			
					'name' => 'Cinema - Category Banner',			
	...
	function cinema_cat_single() {		
		register_sidebar( array(			
					'name' => 'Cinema - Category Single Post',			
	...
	function cinema_cat_latest() {		
		register_sidebar( array(			
					'name' => 'Cinema - Category Latest Posts',			
	...
	********************************************/
	...
	function fashion_cat_trending() {		
		register_sidebar( array(			
					'name' => 'Fashion - Category Trending',			
	...
	function fashion_cat_single() {		
		register_sidebar( array(			
					'name' => 'Fashion - Category Single Post',			
	...
	function fashion_cat_latest() {		
		register_sidebar( array(			
					'name' => 'Fashion - Category Latest Posts',			
	...
	********************************************/
	...
	function gossip_cat_single() {		
		register_sidebar( array(			
					'name' => 'Gossip - Category Single Post',			
	...
	function gossip_cat_latest() {		
		register_sidebar( array(			
					'name' => 'Gossip - Category Latest Posts',			
	...
	********************************************/
	...
	function sport_cat_single() {		
		register_sidebar( array(			
					'name' => 'Sport - Category Single Post',			
	...
	function sport_cat_latest() {		
		register_sidebar( array(			
					'name' => 'Sport - Category Latest Posts',			
	...
	********************************************/
	...
	function trend_cat_single() {		
		register_sidebar( array(			
					'name' => 'Trends - Category Single Post',			
	...
	function trend_cat_latest() {		
		register_sidebar( array(			
					'name' => 'Trends - Category Latest Posts',			
	...
	********************************************/
	...
	function lym_post_relatedPost() {		
		register_sidebar( array(			
					'name' => 'Single Post - Related Posts',			
					'id' => 'single-related-post',
					));	
	}	
	add_action( 'widgets_init', 'lym_post_relatedPost' );
	
	function lym_post_contentAd() {		
		register_sidebar( array(			
					'name' => 'Single Post - Content Ad',			
					'id' => 'single-content-ad',
					));	
	}	
	add_action( 'widgets_init', 'lym_post_contentAd' );
			    		...
			    		<div id="<?php echo esc_html_e( $childTerm->slug ); ?>" class="flex">
			    			<div class="col-12">
			    				<div class="grid-logo">
									...
									<div class="sponsored-by <?php echo esc_html_e( $post_category ); ?> <?php echo $catslug; ?>">
		...
		?>
			...
			<?php if ( $editor_post->have_posts() ) { ?>
				<?php while ( $editor_post->have_posts() ) : $editor_post->the_post(); ?>
					...
					<section class="flex only-border-bottom <?php echo get_parent_category(get_the_ID(), 'slug'); ?>-bg">
	...
	*********************************************/
	...
	/********************************************
		WIDGET - SIDEBAR AD
	*********************************************/
	class lym_sidebarAD_section extends WP_Widget {

		/**		 * Register widget with WordPress.		 */
		function __construct() {
			parent::__construct(
				'lym_sidebarAD_section', // Base ID
				__('(Desiblitz) Sidebar Ad' ), // Name
				array( 'description' => __( 'Displays the code you drop here.' ), ) // Args
			);
		}
		...
		?>
			...
			<div class="left-column-add">
				<figure>
					<?php echo php_execute($ad_code); ?>
				</figure>
			</div>
		...
		public function form( $instance ) {
			...
			?>
				...
				<p>
					<label 
						for="<?php echo $this->get_field_id( 'ad_code' ); ?>">
							<?php _e( 'Ad Code:' ); ?>
					</label>
					<textarea 
						...
						><?php echo esc_html($ad_code); ?></textarea>
	...
	function lym_sidebarAD_widget() {
		register_widget( 'lym_sidebarAD_section' );
	}
	add_action( 'widgets_init', 'lym_sidebarAD_widget' );
	/*************************************************/
			// WIDGET - SIDEBAR AD //
	/*************************************************/
		...
		?>			
			...
			<div class="new-post-list">
				<ul>
					...
					<li>
						<figure class="full-width">
							<a href="<?php the_permalink();?>"><?php if ( has_post_thumbnail() ) {the_post_thumbnail('trending-thumb');} ?></a>
						</figure>
						<h4 class="post-title">
							<a href="<?php the_permalink();?>"><?php the_title();?></a>
						</h4>
	...
	*********************************************/
			...
			<?php if ( $editor_post->have_posts() ) { ?>
				<?php while ( $editor_post->have_posts() ) : $editor_post->the_post(); ?>
					<div class="quoted-wrap">
						...
						<div class="new-post-list quoted">
							<ul>
								<li>
									<figure class="full-width">											
										<a href="<?php the_permalink();?>"><?php if ( has_post_thumbnail() ) {the_post_thumbnail('trending-thumb');} ?></a>
	...
	/********************************************
		WIDGET - CONTENT AD
	*********************************************/
	class lym_contentAd_section extends WP_Widget {

		function __construct() {
			parent::__construct(
				'lym_contentAd_section', // Base ID
				__('(Desiblitz) Content - AD' ), // Name
				array( 'description' => __( 'Display Content Ad' ), ) // Args
			);
		}
		...
		public function widget( $args, $instance ) {
			$widget_title = $instance['widget_title'];
			$ad_shortcode = $instance['ad_shortcode'];
		?>
		...
		public function form( $instance ) {
			if ( isset( $instance[ 'ad_shortcode' ]) ) {
				$ad_shortcode = $instance['ad_shortcode'];
				$widget_title = $instance['widget_title'];
			}
			else {
				$ad_shortcode = __( 'Enter the shortcode' );
				$widget_title = __( 'Widget Title' );
			}
			?>
			...
			<p>
				<label 
					for="<?php echo $this->get_field_id( 'ad_shortcode' ); ?>">
						<?php _e( 'Content Ad:' ); ?>
				</label> 
				<input 
					id="<?php echo $this->get_field_id( 'ad_shortcode' ); ?>" 
					class="widefat" 
					type="text" 
					name="<?php echo $this->get_field_name( 'ad_shortcode' ); ?>" 
					value="<?php echo esc_html($ad_shortcode); ?>" />
			</p>
		...
		public function update( $new_instance, $old_instance ) {
			...
			$instance = array();
			$instance['ad_shortcode'] = ( ! empty( $new_instance['ad_shortcode'] ) ) ? ( $new_instance['ad_shortcode'] ) : '';
			$instance['widget_title'] = ( ! empty( $new_instance['widget_title'] ) ) ? ( $new_instance['widget_title'] ) : '';
			return $instance;
		}
	...
	function lym_contentAd_section_widget() {
		register_widget( 'lym_contentAd_section' );
	}
	add_action( 'widgets_init', 'lym_contentAd_section_widget' );
	/*************************************************/
		// WIDGET - SINGLE PAGE SIDEBAR QUOTED //
	/*************************************************/