...
></div>
 ...
 var stepsheight = 0; 
  ...
  window.verticalScroller = function($elem) {
    ...
    var temp = -1 * $('.sidebar-widget ul.embeddable-job-widget-listings > li').height();
    if(top < temp) {
        top = $('.sidebar-widget ul.embeddable-job-widget-listings').height()
        $elem.css("top", top);
    }
...
setTimeout( function(){ 
			...
			text = text.replace("|", "");
			$(this).html(text);
			 ulheights=$('.homepage-widget ul.embeddable-job-widget-listings').height();	
			var cunt= $('.homepage-widget .no_of_post_sidebar_b').val();
			cunt =(cunt/3);	
			ulheights=(ulheights/cunt)-5;	
...
// setInterval(function() {
    // $(".homepage-widget ul.embeddable-job-widget-listings").animate({
        // 'marginTop': '-=' + slider_w + 'px'
    // }, 100,function () {
// if(parseInt($(".homepage-widget ul.embeddable-job-widget-listings").css("marginTop"), 10) < -( $('.homepage-widget ul.embeddable-job-widget-listings').height() - ulheights))
    // {
	// $(".homepage-widget ul.embeddable-job-widget-listings").css("margin-top","0px");
	// }
	// console.log($('.homepage-widget ul.embeddable-job-widget-listings').height());
	// console.log(parseInt($(".homepage-widget ul.embeddable-job-widget-listings").css("marginTop"), 10));
	 // });
// }, 2000);  
  ...
  // Auto Rotaion Code
// var counter = 1;
// var slider_w = (ulheight / slide_count);
// setInterval(function() {
    // $(".homepage-widget ul.embeddable-job-widget-listings").animate({
        // 'marginTop': '-=' + slider_w + 'px'
    // }, 2000, function () {
        // $(".homepage-widget ul.embeddable-job-widget-listings li:first-child").appendTo(".homepage-widget ul.embeddable-job-widget-listings");
        // $(".homepage-widget ul.embeddable-job-widget-listings").css({
            // 'marginTop': '+=' + slider_w + 'px'
        // });
    // });
// }, 10);
...
// });
	...
	/*******************************************
		(BRSL): Register
	********************************************/
	function reg_jobs_home2() {
		register_widget( 'cus_jobs_home2' );
	}
	add_action( 'widgets_init', 'reg_jobs_home2' );	
	/********************************************
		(BRSL): Body
	*********************************************/
	class cus_jobs_home2 extends WP_Widget 
	{
		function __construct() {
			parent::__construct(
				'cus_jobs_home2', // Base ID
				__('(DESIblitz) Homepage Jobs2 Widget' ), // Name
				array( 'description' => __( 'jobs will show on Hompage tablet' ), ) // Args
			);
		}
