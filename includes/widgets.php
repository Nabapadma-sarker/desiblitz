<?php
	...
	********************************************/
	function lym_home_bannerSlider_left() {		
		register_sidebar( array(			
					'name' => 'Homepage - Whats New left',			
					'id' => 'home-banner-slider-left',
					));	
	}	
	add_action( 'widgets_init', 'lym_home_bannerSlider_left' );
		
	/*******************************************
		WIDGET AREA - HOME BANNER
	********************************************/
	function lym_home_bannerSlider_right() {		
		register_sidebar( array(			
					'name' => 'Homepage - Whats New Right',			
					'id' => 'home-banner-slider-right',
					));	
	}	
	add_action( 'widgets_init', 'lym_home_bannerSlider_right' );
	...
	********************************************/
	...
	/*******************************************
		WIDGET AREA - HOME TWO POSTS LEFT
	********************************************/
	function lym_home_twoPosts_left() {		
		register_sidebar( array(			
					'name' => 'Homepage - Two Posts Left Section',			
					'id' => 'home_two_posts_left',
					));	
	}	
	add_action( 'widgets_init', 'lym_home_twoPosts_left' );
	
	
	/*******************************************
		WIDGET AREA - HOME TWO POSTS RIGHT
	********************************************/
	function lym_home_twoPosts_right() {		
		register_sidebar( array(			
					'name' => 'Homepage - Two Posts Right Section',			
					'id' => 'home_two_posts_right',
					));	
	}	
	add_action( 'widgets_init', 'lym_home_twoPosts_right' );
